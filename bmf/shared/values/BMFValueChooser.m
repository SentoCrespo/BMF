...
- (void) nextValue {
	if (self.value) {
		id<BMFValueChangeNotifyProtocol> valueNotifier = [NSObject BMF_castObject:self.value withProtocol:@protocol(BMFValueChangeNotifyProtocol)];
		[valueNotifier notifyValueChanged:valueNotifier];
	}
}
