...
+ (NSString *) BMF_formattedString:(NSString *) string {
	return [[NSString BMF_nonNilString:string] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
}
