...
- (void) performCancel {
	self.cancelled = YES;
	self.progress.failedError = [NSError errorWithDomain:@"Social Request" code:BMFErrorCancelled userInfo:@{ NSLocalizedDescriptionKey : BMFLocalized(@"Social Request Cancelled",nil) }];
}
